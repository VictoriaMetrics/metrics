...
//
// It is OK to register multiple writeMetrics callbacks - all of them will be called sequentially for generating the output at WritePrometheus.
...
//
//   - go_memstats_stack_sys_bytes - memory requested from the OS for goroutine stacks
//
